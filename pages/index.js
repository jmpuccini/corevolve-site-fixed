...
export default function Home() {
  ...
  <ul style={{
    ...
    <li><a href="#survey">Start Now</a></li>
      ...
      {/* 🧭 About Corevolve */}
      <section id="about" style={{ padding: '7rem 2rem', backgroundColor: '#f7f9fb' }}>
      ...
      {/* ⚙️ Method + Services */}
      <section id="method" style={{ padding: '7rem 2rem' }}>
      ...
      {/* 📚 Case Stories */}
      <section id="case-stories" style={{ padding: '7rem 2rem', backgroundColor: '#f7f9fb' }}>
        <h2>Case Stories</h2>
